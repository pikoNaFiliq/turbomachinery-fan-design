...
C
      IF(TURBO_TYP.EQ.'T') THEN   !   DEFAULTS FOR TURBINES.
           ...
           ZWEIFEL  = 1.1  ! ZWEIFEL COEFFICIENT FOR TURBINES
...
C                            VARY THE CAMBER LINE SHAPE. INCREASING EXPO MOVES THE BLADE LOADING UPSTREAM.
           QLE_ROW1(1) = 90  ! LEADING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 1.
           QTE_ROW1(1) = 90  ! TRAILING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 1.
           QLE_ROW2(1) = 90  ! LEADING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 2.
           QTE_ROW2(1) = 90  ! TRAILING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 2.
      END IF
C
