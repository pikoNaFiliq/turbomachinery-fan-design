...
R = psi/2 - phi*tand(a1) + 1 ;   % Reaction Coefficient
...
U_calc = sqrt( w_LPT_stage / psi); % Calculated rotational speed at the tip !!!!!!!!!!!!!!!!!!
%%%%%%%% How to make it be U_calc_tip ???? %%%%%%%
...
obj = zeta_TE + zeta_SL + zeta_BL;  % Total Loss
