...
V_0 = M_0 * sqrt(k * R * T_0);   % Velocity at the inlet

A_0 = m / (rho_0 * V_0);         % Area at the inlet of the fan
Rt_0 = sqrt(A_0 / pi);           % Radius at the tip ( Assuming that Rh is small compared to Rt)
